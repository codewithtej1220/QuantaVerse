  ...
  return (
    <div className="min-h-screen overflow-x-clip pt-32 pb-24">
      <div className="mx-auto max-w-[1440px] px-5 lg:px-10">
        <header className="flex flex-wrap items-end justify-between gap-x-10 gap-y-5 border-b border-edge pb-7">
          <div className="max-w-2xl">
            <p className="eyebrow">Sandbox · /sandbox</p>
            <h1 className="mt-3 display-2">
              Build the circuit.{" "}
              <span className="text-photon">Watch the state move.</span>
            </h1>
